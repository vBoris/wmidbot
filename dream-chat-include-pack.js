...
function translb(sel){
	...
	$('#wmid_trans').click(function(){
		...
		$.getJSON('https://translate.yandex.net/api/v1.5/tr.json/translate?key=trnsl.1.1.20140925T082047Z.5055d7e52197b592.bda3ad29dbb6a6aa6d19098d6e9748aca550221e&text='+cp1251_to_utf8(unescape($('#message').val()))+'&lang=en',function(s){
			console.log(s.text);
